...
str_replace_all(pattern_lc, "vodka") %>% 
str_replace_all(pattern_uc, "Vodka")
...
```{r}
whole_text %>% 
  str_extract_all("[Mm]inistry|[Mm]inistries|[Dd]epartment|[Mm]ini") 
```
...
pattern_m <- "Ministry"
pattern_ms <- "Ministries"
pattern_d <- "Department"
pattern_mini <- "Mini"

whole_text_final <- whole_text_vodka  %>% 
str_replace_all(pattern_m, "Department") %>% 
str_replace_all(pattern_ms, "Departments") %>% 
str_replace_all(pattern_d, "Sections") %>% 
...
```{r}
whole_text_final %>% 
  str_extract_all("[Dd]epartment|[Dd]epartments|[Ss]ections|[Dd]ep") 
```
