...
summarise(Calorie_count = mean(Calories)) %>%
...
lowest_cal_coffee_drink <- filter(starbucks_short, Beverage == "Coffee" | Beverage == "Espresso" | Beverage == "Latte"| Beverage_category == "Coffee" | Beverage_category == "Latte" ) %>%
  arrange(Calories) %>%
  head(1)
