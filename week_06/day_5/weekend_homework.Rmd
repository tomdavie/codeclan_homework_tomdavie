...
H0: πpop = 0.4
HA: πpop > 0.4
Null hypothesis is that 40% of the town's population have heard of the coffee shop
and the alternative hypothesis is that greater than 40% have heard of it.
Method to generate null distribution - Simulation
...
H0: πpropA - πpropB = 0
HA: πpropA - πpropB < 0
Null hypothesis is that there is no different between prop A and B. Alternative 
hypothesis is that prop A - prop B is less than zero.
Method to generate null distribution - Permutation
...
H0: µpart = 145
HA: µpart != 145
Null hypothesis is that the mean width of parts is 145mm. Alternative hypothesis
is that mean width of parts isn't 145mm
Method to generate null distribution - Bootstrap
...
As our p-value is greater than our significance level we fail to rejected our 
null hypothesis. We do not have statistically significant evidence that shows 
40% or more of the towns population know the coffee shop.
...
As our p-value is less than our significance level we rejected our null hypothesis
in favour of our alternative hypothesis. Therefore, we have statistically significant
evidence that shows putting the banner at the top of the page has a better 
click through rate.
...
As our p-value is greater than our significance level we fail to reject our null 
hypothesis. We do not have statistically significant evidence to show that the 
tool width has drifted from 145mm. 
